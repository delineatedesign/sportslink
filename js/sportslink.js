...
/*
$('#link-form-contactus').on('click', function(e) {
    e.preventDefault();
    $('#footer').removeClass('upload-is-Active');
    $('#footer').addClass('contact-is-Active');
});
*/
...
$(document).ready(function() {
  $('.submenuWrapper').scrollToFixed( { bottom: 0, limit: $('.submenuWrapper').offset().top } );

  $('.submenuWrapper').scrollToFixed({
